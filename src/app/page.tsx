      ...
      <div className="w-full min-h-screen flex flex-col md:flex-row bg-white text-black font-sans">
        ...
        <main className="flex-1 w-full max-w-3xl mx-auto px-6 py-16 text-left text-base">
          ...
          <ul className="list-disc list-inside space-y-3 mb-2">
            ...
            <li className="mt-0">took leave from nyu and founded <a href="https://www.tryswiftlaw.com" className="underline text-blue-700" target="_blank" rel="noopener noreferrer">SwiftLaw</a> and <a href="https://www.carbonpaper.ai" className="underline text-blue-700" target="_blank" rel="noopener noreferrer">CarbonPaper</a> → started as tech-enabled fund formation service and ended up building SwiftLaw, then CarbonPaper, AI-powered document editor for lawyers to replace MS Word; bootstrapped to mid 5 figs ARR</li>
